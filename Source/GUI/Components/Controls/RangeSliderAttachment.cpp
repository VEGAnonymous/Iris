...
void RangeSliderAttachment::updateMin(float value) { rangeSlider.setRange(minParam.convertTo0to1(value), rangeSlider.getEnd()); }
void RangeSliderAttachment::updateMax(float value) { rangeSlider.setRange(rangeSlider.getStart(), maxParam.convertTo0to1(value)); }

/* PUBLIC */

RangeSliderAttachment::RangeSliderAttachment(juce::AudioProcessorValueTreeState& apvts,
